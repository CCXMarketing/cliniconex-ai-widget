...
def acm_alerts_instruction():
    return (
        "\n🧠 Special Instruction:\n"
        "ACM Alerts is designed for **automated reminders and real-time notifications** that are driven by events, appointment statuses, or scheduling rules within the EMR/EHR. It is ideal for routine, patient-specific appointment workflows that require minimal staff intervention.\n\n"
        "✅ Best used for:\n"
        ...
        "⚠️ Can support:\n"
        "- Leave/Return Messaging ONLY in combination with ACM Concierge(for patient movement)\n"
